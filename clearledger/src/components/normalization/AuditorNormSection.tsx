  ...
  findings: [
    {
      ...
      description: 'Документ из 1С (125 400 ₽, ООО «Ромашка») — нет соответствующей записи в TradeLedger',
    ...
    },
    {
      ...
      description: 'TradeLedger: 98 500 ₽ → 1С: 98 050 ₽ (разница 450 ₽)',
      entryId: 'e-demo-1',
      detectedAt: new Date().toISOString(),
    },
    {
      ...
      description: 'В 1С зарегистрировано 84 документа, в TradeLedger — 79 (не хватает 5)',
      detectedAt: new Date().toISOString(),
    },
  ],
  verifiedEntries: [],
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            {result.findings.length > 0 && (
              <Badge variant="outline" className="text-xs border-red-400/50 text-red-300/80">
