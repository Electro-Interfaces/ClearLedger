...
import { useOnWindowResize } from "./chart-utils"
import {
...
import { hasOnlyOneValueForKey } from "./chart-utils"
      ...
      >
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cn("stroke-border stroke-1")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
...
export { ChartTooltip, AreaChart, type AreaChartEventProps, type TooltipProps }
