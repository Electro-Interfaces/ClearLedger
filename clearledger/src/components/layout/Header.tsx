      ...
      <div className="flex h-full items-center justify-between gap-2 px-2 sm:gap-3 sm:px-4 md:px-6">
        ...
        <div className="flex min-w-0 items-center gap-3 md:gap-4">
          ...
          <Link to="/" title="К рабочему столу экосистемы" className="hidden items-center gap-3 shrink-0 lg:flex">
            ...
            {/* Без тени: она осталась от прежней плитки с глифом, где изображала
                подложку. У знака своя форма и свой фон, а декоративная тень под
                постоянным элементом шапки правилами оформления не предусмотрена. */}
        ...
        <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
          ...
          {/* Конференции здесь НЕТ намеренно: шестая кнопка не помещается в мобильную
              шапку — она наезжала на бургер и выдавливала профиль за край экрана
              (проверка МАГа 06.09.2026). Вход в конференцию живёт на пульте. */}
