/**
 * OnboardingWizard — пошаговый диалог для первого знакомства с TradeLedger.
 *
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogTitle className="text-center text-xl">Добро пожаловать в Ledger</DialogTitle>
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription className="text-center">
          Ledger поддерживает мультикомпанейность. Выберите основную компанию для работы.
        </DialogDescription>
      </DialogHeader>
  ...
  return (
    <>
      ...
      <div className="space-y-3 my-4">
        ...
        <button
          className="w-full flex items-center gap-3 p-4 rounded-lg border hover:bg-muted/50 transition-colors text-left"
          onClick={() => { markOnboardingDone(); navigate('/contractors') }}
        >
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription className="text-center">
          Ledger настроен. Вы можете начать работу с документами прямо сейчас.
        </DialogDescription>
      </DialogHeader>
