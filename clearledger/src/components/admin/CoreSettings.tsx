/**
 * Центр управления → Экосистема → «Настройки Ядра». Обзор конфигурации Ядра:
 * SSO, каталог приложений лаунчера, платформенные сервисы. В основном справочно —
 * ключи/секреты задаются в окружении стека (не редактируются из UI по безопасности).
 */
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground">
          ...
          <p className="text-xs pt-2">Состав сервисов управляется профилями стека (STACK_SERVICES) при развёртывании.</p>
        </CardContent>
      </Card>
    </div>
  )
