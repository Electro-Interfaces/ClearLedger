      ...
      <div>
        ...
        <p className="mt-0.5 max-w-3xl text-xs text-muted-foreground">
          {вид === 'recon'
            ...
            : 'Правка документа перед отправкой в 1С. Факт станции при этом не меняется: его видит администратор АЗС в «Магазине» станции и «Торговый центр», и он остаётся доказательством того, как продали.'}
        </p>
      </div>
