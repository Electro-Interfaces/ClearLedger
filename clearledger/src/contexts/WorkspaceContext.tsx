...
export type CoreMode = 'normalize' | 'reconcile' | 'management' | 'operations' | 'store' | 'financial' | 'accounting' | 'tax' | 'export'

const VALID_MODES: CoreMode[] = ['normalize', 'reconcile', 'management', 'operations', 'store', 'financial', 'accounting', 'tax', 'export']
