...
export const DOCS_VIEWS: Record<string, DocsView[]> = {
  ...
  '/docs/work': [
    ...
    // Моя раскладка — как я разложил у себя; ничего из этого компания не видит.
    // Подборки продолжают группу ниже черты и потому своего пункта не имеют.
    { key: 'starred', label: 'Важное', hint: 'помеченное лично: важность своя, приоритет предмета ставит постановщик', group: 'Моя раскладка', badge: 'starred' },
    { key: 'deferred', label: 'Отложено', hint: 'спрятанное у себя до даты — срок компании при этом не менялся', group: 'Моя раскладка', badge: 'deferred' },
