...
export const DOCS_VIEWS: Record<string, DocsView[]> = {
  ...
  '/docs/company': [
    { key: 'work', label: 'Вся работа', hint: 'документы и поручения одной лентой', group: 'Что в работе' },
    { key: 'triage', label: 'Разбор', hint: 'работа без исполнителя: взять, поручить или закрыть', group: 'Что в работе', badge: 'triage' },
    { key: 'errands', label: 'Поручения компании', hint: 'вся работа с отбором, поиском и выгрузкой', group: 'Что в работе' },
