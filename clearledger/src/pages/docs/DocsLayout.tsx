/**
 * Оболочка приложения «Дело»: вторая вертикальная панель — пункты активного
 * раздела.
 *
...
export const DOCS_VIEWS: Record<string, DocsView[]> = {
  ...
  '/docs/work': [
    ...
    { key: 'errands', label: 'Поручения', hint: 'что поручено по документам и в каком состоянии' },
  ],
  '/docs/setup': [
    { key: 'kinds', label: 'Виды документов', hint: 'вид несёт правило нумерации и реквизиты' },
