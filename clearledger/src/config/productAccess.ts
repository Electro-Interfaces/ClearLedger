...
import {
  ...
  MARKET_AREA_MENU, MARKET_PRICE_MENU, MARKET_DECISION_MENU,
...
export const PRODUCT_MODULES: Record<string, ProductModuleDef[]> = {
  ...
  shop: [
    ...
    ...items(storeMenu('store_receipt'), 'Приёмка'),
  ...
  marketing: [...items(MARKET_MENU, 'Рынок'),
              ...
              ...items(MARKET_PRICE_MENU, 'Цена и позиция'),
              ...items(MARKET_DECISION_MENU, 'Решения')],
  finance: [
  ...
  revenue: [
    ...
    ...items(REV_MONEY_MENU, 'Деньги'),
    ...items(REV_STOCK_MENU, 'Закупки'),
    ...items(REV_HELP_MENU, 'Помощь'),
  ],
  econ: [
