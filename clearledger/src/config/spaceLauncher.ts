...
// «Маркетинг» переехал сюда из сервисов экосистемы (решение МАГа 13.09.2026): это
// больше не заготовка под рассылки, а рабочее место развития сети — рынок вокруг
// нас, территории, цена и направления роста. Место ему рядом с «Продажами»: там
// смотрят, кому продаём сегодня, здесь — где продавать завтра.
// «Монитор» переехал сюда из «Управления» (решение МАГа 21.09.2026): состояние
// оборудования торговых точек — часть обслуживания клиента, а не сводка дел
// руководителя. Место рядом с «Поддержкой»: там видно, что сломалось, здесь — что
// с этим делают.
export const COMMERCE_APPS = ['sales', 'marketing', 'support', 'monitor', 'revenue', 'retail_store']
...
export const LEAD_APPS = ['pulse', 'chat', 'docs', 'conf']
...
// Сервис экосистемы — то, что обслуживает работу, а не ведёт её. «Магазин»
// числился сервисом с тех пор, как был универсальным интернет-магазином, у розницы
// это полноценный продукт и стоит он в рабочей строке (03.09.2026). «Маркетинг»
// ушёл в «Клиенты и продажи» (13.09.2026), когда у него появились свои экраны.
export const SERVICE_APPS = ['shop', 'corp', 'processing']
