...
export const SPACE_PRODUCTS: SpaceProduct[] = [
  ...
  {
    // «Реализация» — что компания продала: товары и услуги двумя разделами одного
    // продукта. Раньше это были два приложения («Продажи» и «Услуги») с одним и тем
    // же экраном, и вопрос «сколько мы всего продали» требовал похода по двум
    // плиткам. Разрез остался, рабочее место стало одним (решение МАГа 13.08.2026).
    code: 'revenue', route: '/revenue', label: 'Реализация',
    modes: ['rev_goods', 'rev_services'], paths: [],
  },
  {
