...
const SUB_LABELS: Partial<Record<CoreMode, Record<string, string>>> = {
  management: {
    ...
    cs_dashboard: 'Сессии: обзор', cs_map: 'Сессии: карта', cs_list: 'Сессии: транзакции', cs_sessions: 'Сессии', cs_clients: 'Сессии: тарифы', cs_corporate: 'Сессии: корпоратив', cs_retail: 'Сессии: частные лица',
  },
  operations: {
