...
export interface TankLedgerRow {
  ...
  /** Книга минус факт на КОНЕЦ смены: плюс — недостача, минус — излишек. Это состояние, в нём сидит и старое расхождение. */
  fact_gap: number | null
  /** Расхождение на НАЧАЛО смены: книга начала против последнего замера (конец предыдущей). */
  fact_gap_start: number | null
  /** Набежало ИМЕННО за смену: расхождение на конец минус на начало. */
