...
export interface TaxesData {
  ...
  taxMode?: string | null
  /** «доходы» | «доходы минус расходы» | null — объект упрощёнки из настроек 1С. */
  usnObject?: string | null
  /** Что является базой налога: выручка, доходы минус расходы, прибыль до налога. */
  taxBaseLabel?: string | null
  /** Процент налога к выручке — считается только когда база и есть выручка. */
  taxBasePct?: number | null
  loadNote?: string
