...
export interface CompanyRef {
   ...
   *  за всей, руководитель подразделения — за своей веткой. От этого зависит,
   *  показывать ли раздел «Компания». */
  oversees?: boolean // RBAC: разрешённые модули; null/undefined = полный доступ
}
