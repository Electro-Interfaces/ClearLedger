...
SYSTEM_ROLES_OFFICE: list[dict] = [
    ...
    {"name": "Руководитель", "modules": ["pulse", "plan", "support", "chat", "books", "trade", "svc"]},
    # Бухгалтер видит эталон целиком; продажи и услуги — его же данные под другим углом.
    {"name": "Бухгалтер", "modules": ["books", "trade", "svc", "chat"]},
    # Коммерсант — только разрезы: кому продаём и что оказываем. Регистр ему не нужен.
    {"name": "Коммерсант", "modules": ["trade", "svc", "chat"]},
