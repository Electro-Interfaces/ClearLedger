...
# Типы коннекторов ЭЗС (charge sessions) → канон
_CONNECTOR_SEED = {
    "type2": "Type 2", "тип2": "Type 2", "тип 2": "Type 2",
    "ccs": "CCS Combo 2", "ccs2": "CCS Combo 2", "combo2": "CCS Combo 2",
    "chademo": "CHAdeMO", "чадемо": "CHAdeMO",
    "gbt_dc": "GB/T DC", "gbt dc": "GB/T DC",
    "gbt_ac": "GB/T AC", "gbt ac": "GB/T AC",
...
def canon_region(raw) -> str | None:
    ...
    if low.startswith("республика "):
        low = low[len("республика "):].strip()
