...
_KIND_TO_TYPE = {
    ...
    # «Расход материалов» — синоним требования-накладной в этой конфигурации.
    "Расход материалов": "demand_note",
    "Списание товаров": "goods_writeoff",
    ...
    # Виды компании на УСН и там, где ведут кадры. Карту надо держать полной: вид,
    # которого в ней нет, снимается как ложная связь — сведение молча откатывает
    # работу предыдущего шага, и проводка остаётся без документа.
    "Отпуск": "vacation",
    ...
    # Агентская схема и прочее, что встречается у компании-агента.
