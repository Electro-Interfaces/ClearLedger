...
# Разделы «Сайта». Публичная витрина и кабинет клиента ведутся НА САЙТЕ — он остаётся
# хозяином своих данных, как внешний трекер у Поддержки. Здесь их читают из пространства:
# кто написал, кого завели, кому открывали стенд, что показано в витрине.
...
_CARVED_BY_PROFILE: dict[str, set[str]] = {
    ...
    "fuel": {"sales", "shop", "ops", "finance", "data", "connect", "docs"},
