...
_CARVED_BY_PROFILE: dict[str, set[str]] = {
    ...
    # «Дело» — документооборот. Обкатывается на пилоте сети и в офисном
    # пространстве (решение МАГа 16.08.2026); остальным профилям подключится,
    # когда пройдут визы и номенклатура дел.
...
# «Задачи» здесь больше нет: поручения переехали в «Дело» (решение МАГа
# 16.08.2026). Продукт остаётся в каталоге — его ручки обслуживают поручения
# внутри «Дела», — но отдельной плиткой в лаунчере не показывается: два места
