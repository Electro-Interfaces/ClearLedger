...
_APPS: list[dict[str, Any]] = [
    ...
    {"code": "books", "name": "Бухгалтерия", "icon": "book-open", "sort": 20,
     ...
     "modules": []},
    {"code": "trade", "name": "Продажи", "icon": "bar-chart-3", "sort": 21,
     "desc": "Кому и что продаём: динамика, покупатели, товары", "modules": []},
    {"code": "svc", "name": "Услуги", "icon": "briefcase", "sort": 22,
     "desc": "Оказанные услуги: динамика, заказчики, виды работ", "modules": []},
...
_CARVED_BY_PROFILE: dict[str, set[str]] = {
    ...
    # «Продажи» и «Услуги» (те же данные под своим углом). «Данные» — та же служебная
    # кухня, что у сетевых профилей: карта нормализованной базы и коннекторы, только
    # домен в карте свой («Бухгалтерия-эталон», см. services/space_data_model.py).
    "office": {"books", "trade", "svc", "data"},
}
