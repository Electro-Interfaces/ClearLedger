...
async def route_nodes(db: AsyncSession, company_id) -> dict[str, Any]:
    ...
    return {
        ...
        # По маршруту ведётся не всякий проект: пока по нему не сделали ни шага,
        # процесса нет вовсе и узла у него нет. Экран называет это числом, а не
        # делает вид, что показывает всю воронку.
        "known": известно,
        "active": живых,
    }
