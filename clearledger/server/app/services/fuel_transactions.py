...
Грейн — один налив на ТРК (в отличие от FuelShiftSale = агрегат смена×канал×топливо).
Даёт счётчик наливов (как в эталонной системе), реестр операций и точные метрики.
